...
const statusSteps = [
  { label: "Room linked", value: "Active" },
  { label: "Translation", value: "Ready" },
  { label: "Safe-path", value: "Available" },
];
            ...
            <div className="relative space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {statusSteps.map((step) => (
                  <Card key={step.label} variant="glass" padding="sm">
        ...
        <div className="space-y-6">
          ...
          <Card variant="elevated" hover>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <Button variant="danger" size="lg" pulse>
                Trigger SOS
              </Button>
